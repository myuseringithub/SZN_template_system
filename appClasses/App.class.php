...
class App {
  ...
  public function __construct() {
    ...
    self::$locations['firebase']['defaultUrlPath']  = '/' . 'domains/'. str_replace(".", "", str_replace("www.", "", $_SERVER['HTTP_HOST']));// remove www if present to get the correct name for firebase and get domain.
